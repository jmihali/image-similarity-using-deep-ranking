...
def main():
    ...
    train_set_length = int(1 * len(food_dataset))
    ...
    trainloader = DataLoader(food_dataset, batch_size=5, shuffle=True, num_workers=4)
    ...
    test_dataset = FoodDataset(file='/home/jmihali/Projects/image-similarity-using-deep-ranking/src/test_triplets.txt',
                               root_dir='/home/jmihali/Projects/image-similarity-using-deep-ranking/food',
                               transform=data_transform, label=False)
